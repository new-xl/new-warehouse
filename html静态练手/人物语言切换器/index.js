...
const nameEl = informationEl.querySelector('.name')
const positionEl = informationEl.querySelector('.position')
...
article.addEventListener('animationiteration',function(){
    num++
